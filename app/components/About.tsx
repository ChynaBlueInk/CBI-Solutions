    ...
    <section className="py-20 px-4 bg-[hsl(30,48%,94%)]">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-teal-900 mb-6">About CBI Solutions</h2>
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              At Chyna Blue Ink, we believe in the power of creativity to transform education and business. Our mission
              is to provide innovative digital solutions that guide educators, creatives, and entrepreneurs in sharing
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-teal-100 to-yellow-100 rounded-3xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                />
                <h3 className="text-xl font-semibold text-center text-teal-900">Chyna Blue Ink</h3>
